...
int main(int argc, char ** argv) {
...

    {
      ...
      loadMarket(b, "8x8.mtx");
      VbcscMatrix vb(b, 8, 8);
      MatrixXd c_expected = a * b;
      MatrixXd c_actual = MatrixXd::Zero(m,n);

      dxsp_general_8x8x8_4(a.data(), vb.values, c_actual.data());
      ...
      printf("dxsp_general_8x8x8_4, %lf\n", microsecs(start,end)/3000.0);
    }
...
Options
1. Reuse same objects, declaring them with an initial max size
2. Recreate every time, from separate block
3. From separate function
