...
AsmType = Enum('AsmType', 'unknown i8 i16 i32 i64 f32 f64 f32x4 f32x8 f32x16 f64x2 f64x4 f64x8')
...
rbx = Register(i64, "rbx")
rcx = Register(i64, "rcx")
...
class MemoryAddress(Operand):
    ...
    def __init__(self, pointer, offset, alignment=None):
