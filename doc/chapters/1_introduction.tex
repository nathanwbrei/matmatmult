...
\caption{Block diagram of the Knights Landing architecture, taken from~\cite{Sodani2016KnightsLS}. As shown in (a), each processor is divided into 36 tiles connected in a 2D mesh. As shown in (b), each tile contains 2 cores and a shared L2 cache. Each core has two VPUs and its own L1 caches.}
\end{figure}
