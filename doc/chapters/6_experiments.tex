...
The speedups of each kernel relative to dense are shown in Figure~\ref{fig:unrolled_sizing}. The plots for $bm=24,32$ have been omitted, but they show the same trends. Firstly, 
